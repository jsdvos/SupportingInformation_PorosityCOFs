...
sys = System.from_file('ABCDEF_full86.chk')
...
while True:
    opt.run(10000)
    opt.dof.ff.system.to_file('ABCDEF_full86_save{}.chk'.format(opt.counter))
    if opt.dof.converged:
        opt.dof.ff.system.to_file('ABCDEF_full86_opt.chk')
        break
